...
<script>
    $(document).ready(function() {
        ...
        $('#totalInvestAmount').on('input', function() {
          calculate();
        });
        $('#amountInvest').on('input', function() {
         calculate();
        });
        function calculate(){
            var totalInvestAmount = parseInt($('#totalInvestAmount').val()); 
            var amountInvest = parseInt($('#amountInvest').val());
            var perc="";
            if(isNaN(totalInvestAmount) || isNaN(amountInvest)){
                perc=" ";
               }else{
               perc = ((amountInvest/totalInvestAmount) * 100).toFixed(3);
               }
				...
				<div class="row">
					...
					<div class="col-md-12 ">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Add Investment <small>Details</small>
								</h2>
							...
							<div class="x_content">
								...
								<form id="investmentFormId"
									...
									<div class="form-group row ">
										...
										<div class="col-md-6 col-sm-9 ">
											<input type="number" name="totalInvestAmount"
												class="form-control" placeholder="Enter Total Amount">
										</div>
									</div>
									<div class="form-group row ">
										<label class="control-label col-md-3 col-sm-3 ">Amount Investment By Us</label>
										<div class="col-md-6 col-sm-9 ">
									...
									<div class="form-group row ">
										<label class="control-label col-md-3 col-sm-3 ">Our Percentage</label>
										<div class="col-md-6 col-sm-9 ">
											<input type="number" min="1" max="100" name="percentage"
												class="form-control" placeholder="Our Percentage">
										</div>
									</div>
										<div class="form-group row ">
										<label class="control-label col-md-3 col-sm-3 ">Duration In Month</label>
										<div class="col-md-6 col-sm-9 ">
