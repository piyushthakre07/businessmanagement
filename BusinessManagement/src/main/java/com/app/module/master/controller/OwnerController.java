...
public class OwnerController {
	...
	@GetMapping(value = "/showOwner", produces = MediaType.APPLICATION_JSON_VALUE)
	public ModelAndView showMaterialCategory() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("/ownerMaster");
		return mv;
	}
	...
	public ResponseEntity<Object> DisplayAllOwners() {
		try {
			return new ResponseEntity<>(ownerService.displayAllOwners(), HttpStatus.OK);
			/*
